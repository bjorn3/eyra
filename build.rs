fn main() {
    ...
    for file in [
        ...
        "src/locale/__lctrans.lo",
        "src/locale/c_locale.lo",
        ...
        "src/time/__map_file.lo",
        "src/time/__month_to_secs.lo",
        "src/time/__secs_to_tm.lo",
        "src/time/__tm_to_secs.lo",
        "src/time/__tz.lo",
        "src/time/__utc.lo",
        "src/time/__year_to_secs.lo",
